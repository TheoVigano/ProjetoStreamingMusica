...
public class FrLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlPrincipal.add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 150, -1, -1));
        ...
        pnlPrincipal.add(lblSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 220, -1, -1));

        edtUsuario.setBackground(new java.awt.Color(76, 76, 76));
        edtUsuario.setFont(new java.awt.Font("Noto Sans", 0, 14)); // NOI18N
        edtUsuario.setForeground(new java.awt.Color(255, 255, 255));
        pnlPrincipal.add(edtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 180, 250, 30));

        edtSenha.setBackground(new java.awt.Color(76, 76, 76));
        ...
        pnlPrincipal.add(edtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 250, 250, 30));

        btnEntrar.setBackground(new java.awt.Color(0, 151, 178));
        ...
        pnlPrincipal.add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 320, 140, 40));
        ...
        pnlPrincipal.add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 30, 80, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/user.png"))); // NOI18N
        pnlPrincipal.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 70, -1, -1));
